    ...
    <div class="lot-item__content">
        <div class="lot-item__left">
            <div class="lot-item__image">
                <img src="/uploads/<?= htmlspecialchars($lot_info['img']); ?>" width="730" height="548"
                     alt="<?= htmlspecialchars($lot_info['lot_name']); ?>">
            </div>
            <p class="lot-item__category">Категория: <span><?= htmlspecialchars($lot_info['category_name']); ?></span>
            </p>
                    ...
                    <form class="lot-item__form" method="post" autocomplete="off">
                        <p class="lot-item__form-item form__item <?= empty($errors['bid']) ?: 'form__item--invalid' ?>">
                            ...
                            <input id="bid" type="text" name="bid"
                                   placeholder="<?= htmlspecialchars($lot_info['price'] + htmlspecialchars($lot_info['rate_step'])); ?>">
