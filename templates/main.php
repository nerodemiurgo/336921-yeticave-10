        ...
        <ul class="promo__list">
			<?php foreach ($categories as $item): ?>
				<li class="promo__item promo__item--<?=htmlspecialchars($item['code']); ?>">
					<a class="promo__link" href="/all-lots.php?cat=<?=htmlspecialchars($item['code']); ?>"><?=htmlspecialchars($item['name']); ?></a>
				</li>
			<?php endforeach; ?>
        </ul>
    </section>
        ...
        <ul class="lots__list">
            ...
            <li class="lots__item lot">
                ...
                <div class="lot__info">
                    ...
                    <h3 class="lot__title"><a class="text-link" href="/lot.php?id=<?=htmlspecialchars($item['lot_id']); ?>"><?=htmlspecialchars($item['lot_name']); ?></a></h3>
